...
# w7/amd64 is this guest's driver build in the virtio-win tree.
SRC="$tmp/vioserial/w7/amd64"
[[ -d "$SRC" ]] || { echo "no vioserial/w7/amd64 in $VIRTIO_ISO" >&2; exit 1; }
...
echo "drivers: vioserial/w7/amd64 -> unattend/drivers/vioserial"
