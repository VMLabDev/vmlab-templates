// Build provision for the windows-server-2016 template (PRD §6.1, §10.4). The whole
...
fn install(lab: Lab) -> Result[unit, string] {
    ...
    lab.log("installing Windows Server 2016 + sysprep; the answer file powers off when done (20-50 min)...")
...
fn main(lab: Lab) {
    install(lab).expect("windows-server-2016 build failed")
}
