// Build provision for the windows-7 template (PRD §6.1, §10.4). The whole
...
fn install(lab: Lab) -> Result[unit, string] {
    ...
    lab.log("installing Windows 7 (x86) + sysprep; the answer file powers off when done (20-50 min)...")
...
fn main(lab: Lab) {
    install(lab).expect("windows-7 build failed")
}
