// Build provision for the windows-8 template (PRD §6.1, §10.4). The whole
...
fn install(lab: Lab) -> Result[unit, string] {
    ...
    lab.log("installing Windows 8 (x86) + sysprep; the answer file powers off when done (20-50 min)...")
...
fn main(lab: Lab) {
    install(lab).expect("windows-8 build failed")
}
