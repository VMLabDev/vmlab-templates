...
# w8/x86 is this guest's driver build in the virtio-win tree.
SRC="$tmp/vioserial/w8/x86"
[[ -d "$SRC" ]] || { echo "no vioserial/w8/x86 in $VIRTIO_ISO" >&2; exit 1; }
...
echo "drivers: vioserial/w8/x86 -> unattend/drivers/vioserial"
